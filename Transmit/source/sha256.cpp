...
/*
//  Source Taken in bits and piece from internet for UWE assigment Group15
// MD5 to non reversible encryption
// data  - Original string which needs to be encrypted with sha256
// len - Length of Original String
// sha2digest - Pointer to Output Buffer where the function will return sha256 encrypted String
*/
void sha256(const void *data, size_t len, char *sha2digest)
{
	sha256_context ctx;
